<%-- 
    Document   : booking
    Created on : Apr 10, 2023, 8:44:41 PM
    Author     : nitro 5
--%>
            ...
            <div class="menu-items">
                <ul class="nav-links">
                    <li><a href="">
                            ...
                            <span class="link-name">Booked List</span>
                        </a></li>
                ...
                <table>
                    <thead>
                     ...
                     <tbody id="paginated-list" data-current-page="1" aria live="polite">
                        <c:forEach items="${BookList}" var="customer">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="user?page=accept&id=${customer.bookingid}&value=accepted" class="btn-accept">Accept</a>
                                    
                                    <a href="user?page=reject&id=${customer.bookingid}&value=rejected" class="btn-reject">Reject</a>
