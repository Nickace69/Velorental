<%-- 
    ...
    Created on : Apr 6, 2023, 4:55:14 PM
    Author     : nitro 5
--%>
<%-- 
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="user?page=editvehicle&id=${student.roomid}" class="btn-edit">Edit</a>
                                <a href="user?page=deletevehicle&id=${student.roomid}" class="btn-delete">Delete</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
