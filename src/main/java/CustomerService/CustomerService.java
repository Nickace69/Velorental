...
public class CustomerService {
    ...
    public void insertBoking(Customer customer){
        String query ="insert into booking(fullname, age, contact, address,status)" + "values(?,?,?,?,?)";
        ...
        try{
            ...
            ps.setString(5, customer.getBookingStatus());
            ps.execute();
    ...
    public Customer changePassword( Customer customer, String username) {
        ...
        try {
            ...
            ps.executeUpdate();
            System.out.println("database ma naya pass change vayo ");
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
        return customer;
