    ...
    <body>
        ...
        <nav>
            ...
            <ul>
                ...
                <li><a class="active" href="admin?page=listvehicle">Rental Listing</a></li>
        ...
        <div class="bodyy">
            <div class="fir">
                <h2>List of The Available Vehicles</h2>
            </div>
                ...
                <div class="houses">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <span class="house-addeds">Rs: ${student.roomprice}</span><br />
                            <button type="button" class="btn-book" > <a href="admin?page=vehiclesdetails"> Details </a></button>
