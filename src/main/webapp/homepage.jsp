        ...
        <div class="main_container">
            ...
            <nav>
                ...
                <ul>
                    ...
                    <li><a href="admin?page=listvehicle">Rental Listing</a></li>
                    <li><a href="CustomerPage/contact.jsp">Contact Us</a></li>
                   <!-- <li><a href="#">About Us</a></li>-->

                    <div class="boxx">
                        <i class="fa fa-user-circle" style ="font-size:30px;margin-top:-5px;margin-left: -150px;"></i>
                        <div class="small-box"   >
            ...
            <div class="body">
                ...
                <div class="first">
                    ...
                    <div class="houses">
                        <img src="CustomerPage/fzs-fi-dlx_360x240.webp" style=" height:60%;widht:100%;" />
                        <span class="house-title">fzs V3</span><br />
                          <!--<span class="house-location">Location: Ekantakuna, Kathmandu</span><br />-->
                        <span class="house-addeds">Price: 800/hr</span><br />
                        <button type="button" class="btn-book"> <a href="CustomerPage/vehicledetails.jsp"> Details
                            </a></button>
                ...
                <div class="fir">
                    <h2>Why VeloRenta</h2><br><bR>
                    <h3>Get a complete update on Rental and Sale of Property</h3>
                </div>
                <div class="why">
                    <div class="box">
                        <h2>Easily Listing</h2>
                        <p>Comprehensive listing for affordable rental vehicles in your locality</p>
                    </div>
                    <div class="box">
                    ...
                    <div class="box">
                        ...
                        <p>Happy Customers who found a new vehisle for renting using VeloRenta.</p>
                    </div>
